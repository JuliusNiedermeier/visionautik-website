...
export const repeatables = {
  offer: { typeName: 'offer__repeatable', categories: ['course', 'event'] }, // deprecated (now activity)
  activity: { typeName: 'offer__repeatable', categories: ['course', 'event'] },
  ...
  organization: {
    typeName: 'organization__repeatable',
    categories: ['partner', 'membership'],
  },
