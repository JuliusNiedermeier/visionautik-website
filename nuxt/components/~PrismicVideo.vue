<template>
  <div class="va-el--PrismicVideo" v-if="videoStreams != null">
    <br />
    <video
      v-for="(stream, key) in videoStreams"
      :key="key"
      width="320"
      height="240"
      controls
    >
      <source :src="videoStreams[0].url" type="video/mp4" />
...
export default {
  ...
  async fetch() {
    const videoDetails = await YouTube.getInfo({
      url: 'https://www.youtube.com/watch?v=9CWf1pU_R5c',
    })
