...
export default async (context, inject) => {
  ...
  let api = await Prismic.api('https://visionautikde.cdn.prismic.io/api/v2', Object.assign({}, options,  {}))
  ...
  let prismic = new Vue({
    computed: {
      ...
      apiEndpoint() {
        return 'https://visionautikde.cdn.prismic.io/api/v2'
      },
      predicates() {
  ...
  if (process.client) {
    window.onNuxtReady && window.onNuxtReady(() => {
      ...
      script.src = '//static.cdn.prismic.io/prismic.min.js?repo=visionautikde&new=true'
